...
import { FormsModule } from '@angular/forms'; // Módulo de formulário - É necessário para alguns recursos como o ngModel
import 'rxjs/add/operator/map'; // Adiciona o map ao Observable

@NgModule({
    imports: [BrowserModule, FotoModule, HttpModule, PainelModule, routing, FormsModule], // Array de módulos que queremos importar
